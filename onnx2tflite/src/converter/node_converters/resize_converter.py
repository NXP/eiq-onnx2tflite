...
class ResizeConverter(NodeConverter):
    ...
    def _down_sampling(self, x: tflite_model.Tensor, y: tflite_model.Tensor):
        ...
        return any(y_dim < x_dim for x_dim, y_dim in zip(x.shape, y.shape))
    ...
    def convert(self, node: onnx_model.NodeProto, t_op: tflite_model.Operator) -> list[tflite_model.Operator]:
        ...
        if o_resize.mode == 'linear':
            ...
            if o_resize.coordinate_transformation_mode == 'asymmetric' and o_resize.nearest_mode == 'floor':
                # TFLite can handle this natively.
                pass
            elif o_resize.coordinate_transformation_mode != 'asymmetric' and \
                ...
                if self.context.conversion_config.accept_resize_rounding_error:
