...
from onnx2tflite.src.tflite_optimizer.operator_rules import WasNotInTheOriginalONNXModel
...
from onnx2tflite.src.tflite_optimizer.tensor_rules import TensorHasOneConsumer, TensorsArePerTensorQuantized, \
    TensorsHaveSameType
