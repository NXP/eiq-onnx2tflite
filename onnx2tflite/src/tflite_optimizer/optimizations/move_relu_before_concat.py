...
from onnx2tflite.src.tflite_optimizer.operator_rules import AllInputsComeFrom
...
from onnx2tflite.src.tflite_optimizer.tensor_rules import TensorHasOneConsumer, TensorsHaveSameQuantization
