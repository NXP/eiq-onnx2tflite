...
NODE = {
    ...
    "test_globalaveragepool": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_globalaveragepool_precomputed": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_globalmaxpool": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_globalmaxpool_precomputed": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_greater": {},
    "test_greater_bcast": {},
    "test_greater_equal": {},
    ...
    "test_hardsigmoid": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_hardsigmoid_default": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    # "test_hardsigmoid_default_expanded_ver18": {},  # Uses CastLike, Add, Mul, Min and Max instead of HardSigmoid.
    "test_hardsigmoid_example": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    ...
    "test_instancenorm_epsilon": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_instancenorm_example": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    # "test_isinf": {},
    # "test_isinf_float16": {},
    # "test_isinf_negative": {},
    # "test_isinf_positive": {},
...
PYTORCH_CONVERTED = {
    ...
    "test_ConstantPad2d": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv1d": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv1d_dilated": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv1d_groups": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv1d_pad1": {COMPARISON_ARGS: {"atol": 1e-7}, CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv1d_pad1size1": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv1d_pad2": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv1d_pad2size1": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv1d_stride": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv2d": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv2d_depthwise": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv2d_depthwise_padded": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv2d_depthwise_strided": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv2d_depthwise_with_multiplier": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv2d_dilated": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv2d_groups": {COMPARISON_ARGS: {"atol": 1e-7}, CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv2d_groups_thnn": {COMPARISON_ARGS: {"atol": 1e-7}, CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv2d_no_bias": {COMPARISON_ARGS: {"atol": 1e-7}, CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Conv2d_padding": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    ...
    "test_Conv3d_stride_padding": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_ConvTranspose2d": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_ConvTranspose2d_no_bias": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    # "test_ELU": {},
    # "test_Embedding": {},
    # "test_Embedding_sparse": {},
    # "test_GLU": {},
    # "test_GLU_dim": {},
    "test_LeakyReLU": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_LeakyReLU_with_negval": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    # "test_Linear": {},  # ONNXRT: Not implemented in ONNX Runtime
    "test_Linear_no_bias": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_log_softmax_dim3": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_log_softmax_lastdim": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    ...
    "test_softmax_functional_dim3": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_softmax_lastdim": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_Softmin": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    # "test_Softplus": {},
    # "test_Softsign": {},
    "test_Tanh": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_ZeroPad2d": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
}
...
PYTORCH_OPERATOR = {
    ...
    # "test_operator_addmm": {},
    # "test_operator_basic": {},
    "test_operator_chunk": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_clip": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_concat2": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_conv": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_convtranspose": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_exp": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_flatten": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_index": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_max": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_maxpool": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_min": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    # "test_operator_mm": {},
    # "test_operator_non_float_params": {},
    "test_operator_pad": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    # "test_operator_params": {},
    "test_operator_permute2": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    # "test_operator_pow": {},  # ONNXRT: Pow version 1. Not supported by ONNX Runtime.
    "test_operator_reduced_mean": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_reduced_mean_keepdim": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    # "test_operator_reduced_sum": {},
    # "test_operator_reduced_sum_keepdim": {},
    "test_operator_repeat": {},
    "test_operator_repeat_dim_overflow": {},
    # "test_operator_selu": {},
    "test_operator_sqrt": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    # "test_operator_symbolic_override": {},
    "test_operator_symbolic_override_nested": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
    "test_operator_view": {CONVERSION_ARGS: {"skip_opset_version_check": True}},
}
