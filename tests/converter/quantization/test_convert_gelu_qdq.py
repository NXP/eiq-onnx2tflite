...
def test_convert_gelu_qdq(intermediate_tflite_model_provider):
    input_shape = [4, 6]
    ...
    assert (intermediate_tflite_model_provider.get_operator_code_at_index(1) == BuiltinOperator.GELU)
