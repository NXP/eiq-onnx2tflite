...
from onnx2tflite.src.tflite_generator.builtin_options import dequantize_options, quantize_options, reduce_prod_options
from tests import executors


def test_convert_reduce_prod_qdq(intermediate_tflite_model_provider):
    input_shape = [4, 6]
    ...
    assert isinstance(ops[1].builtin_options, reduce_prod_options.ReduceProd)
