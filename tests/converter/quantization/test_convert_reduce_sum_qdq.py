...
from onnx2tflite.src.tflite_generator.builtin_options import dequantize_options, quantize_options, sum_options
from tests import executors


def test_convert_reduce_sum_qdq(intermediate_tflite_model_provider):
    input_shape = [4, 6]
    ...
    assert isinstance(ops[1].builtin_options, sum_options.Sum)
